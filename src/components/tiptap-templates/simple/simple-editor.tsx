...
// Define the props interface for SimpleEditor
interface SimpleEditorProps {
  initialContent?: any; // JSON content for the editor (can be refined to a specific type)
  onUpdate?: ({ editor }: { editor: any }) => void; // Callback for editor updates
}
